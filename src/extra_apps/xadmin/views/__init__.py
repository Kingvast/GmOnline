...
__all__ = ('BaseAdminObject', 'BaseAdminPlugin', 'BaseAdminView',
           ...
           'DeleteAdminView', 'DetailAdminView', 'FormAdminView', 'Dashboard',
           'BaseWidget', 'IndexView', 'LoginView', 'LogoutView', 'filter_hook',
           'csrf_protect_m')
...
def register_builtin_views(site):
    ...
    site.register_view(
        r'^settings/user$', UserSettingView, name='user_settings')
