...
class Course(models.Model):
    ...
    category = models.CharField(
        default=u'前端开发', max_length=20, verbose_name=u'课程类别')
    tag = models.CharField(default='', verbose_name=u'课程标签', max_length=10)
    you_need_know = models.CharField(
        default='', max_length=300, verbose_name=u'课程须知')
    teacher_tell = models.CharField(
        default='', max_length=300, verbose_name=u'老师告诉你')
...
class Video(models.Model):
    ...
    lesson = models.ForeignKey(
        Lesson, on_delete=models.CASCADE, verbose_name=u'章节')
